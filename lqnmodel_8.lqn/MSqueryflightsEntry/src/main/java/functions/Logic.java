...
public class Logic implements HttpFunction {
	private static final Logger logger = Logger.getLogger("MSqueryflightsEntry");
	 ...
	 * activities
	 */
	public void MSqueryflightsEntry_A1(){
		this.act_exec.put("MSqueryflightsEntry_A1", true);
		this.doWork(0.0294);
	}
	 ...
	 * Dnodes
	 */
	public void ReplyNode_MSqueryflightsEntry_A1(){
		//ReplyNode Logic
		BufferedWriter writer;
		try {
			writer = this.response.getWriter();
			writer.write("MSqueryflightsEntry_A1[MSqueryflightsEntry]");
		} catch (IOException e) {
	...
	public void service(HttpRequest request, HttpResponse response) throws IOException {
		...
		MSqueryflightsEntry_A1();
		//execetute the decision node of already executed evt
		if(this.act_exec.get("MSqueryflightsEntry_A1")!=null && this.act_exec.get("MSqueryflightsEntry_A1")) {
		  this.act_exec.put("MSqueryflightsEntry_A1",false);
		  ReplyNode_MSqueryflightsEntry_A1();
		}
