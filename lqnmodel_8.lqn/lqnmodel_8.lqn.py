...
if __name__ == '__main__':
	...
	clientEntryclientEntry_A7=Activity(stime=0.04593, parent=clientEntry, name="clientEntry_A7")
	...
	MSauthEntryMSauthEntry_A2=Activity(stime=0.07865, parent=MSauthEntry, name="MSauthEntry_A2")
	...
	MSvalidateidEntryMSvalidateidEntry_A1=Activity(stime=0.17135, parent=MSvalidateidEntry, name="MSvalidateidEntry_A1")
	...
	MSviewprofileEntryMSviewprofileEntry_A1=Activity(stime=0.11182, parent=MSviewprofileEntry, name="MSviewprofileEntry_A1")
	...
	MSupdateprofileEntryMSupdateprofileEntry_A1=Activity(stime=0.05025, parent=MSupdateprofileEntry, name="MSupdateprofileEntry_A1")
	...
	MSupdateMilesEntryMSupdateMilesEntry_A1=Activity(stime=1.54282, parent=MSupdateMilesEntry, name="MSupdateMilesEntry_A1")
	...
	MSbookflightsEntryMSbookflightsEntry_A5=Activity(stime=0.03388, parent=MSbookflightsEntry, name="MSbookflightsEntry_A5")
	...
	MScancelbookingEntryMScancelbookingEntry_A3=Activity(stime=0.04767, parent=MScancelbookingEntry, name="MScancelbookingEntry_A3")
	...
	MSqueryflightsEntryMSqueryflightsEntry_A1=Activity(stime=0.0294, parent=MSqueryflightsEntry, name="MSqueryflightsEntry_A1")
	...
	MSgetrewardmilesEntryMSgetrewardmilesEntry_A1=Activity(stime=0.04593, parent=MSgetrewardmilesEntry, name="MSgetrewardmilesEntry_A1")
	...
	LQN={"tasks":[T_clientEntry ,T_MSauthEntry,T_MSvalidateidEntry,T_MSviewprofileEntry,T_MSupdateprofileEntry,T_MSupdateMilesEntry,T_MSbookflightsEntry,T_MScancelbookingEntry,T_MSqueryflightsEntry,T_MSgetrewardmilesEntry], "name":"lqnmodel_8.lqn"}
