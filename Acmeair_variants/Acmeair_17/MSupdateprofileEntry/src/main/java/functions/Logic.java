...
public class Logic implements HttpFunction {
	private static final Logger logger = Logger.getLogger("MSupdateprofileEntry");
	 ...
	 * activities
	 */
	public void MSupdateprofileEntry_A1(){
		this.act_exec.put("MSupdateprofileEntry_A1", true);
		this.doWork(0.02312);
	}
	 ...
	 * Dnodes
	 */
	public void ReplyNode_MSupdateprofileEntry_A1(){
		//ReplyNode Logic
		BufferedWriter writer;
		try {
			writer = this.response.getWriter();
			writer.write("MSupdateprofileEntry_A1[MSupdateprofileEntry]");
		} catch (IOException e) {
	...
	public void service(HttpRequest request, HttpResponse response) throws IOException {
		...
		MSupdateprofileEntry_A1();
		//execetute the decision node of already executed evt
		if(this.act_exec.get("MSupdateprofileEntry_A1")!=null && this.act_exec.get("MSupdateprofileEntry_A1")) {
		  this.act_exec.put("MSupdateprofileEntry_A1",false);
		  ReplyNode_MSupdateprofileEntry_A1();
		}
