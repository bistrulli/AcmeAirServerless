...
public class Logic implements HttpFunction {
	private static final Logger logger = Logger.getLogger("MSviewprofileEntry");
	 ...
	 * activities
	 */
	public void MSviewprofileEntry_A1(){
		this.act_exec.put("MSviewprofileEntry_A1", true);
		this.doWork(0.02468);
	}
	 ...
	 * Dnodes
	 */
	public void ReplyNode_MSviewprofileEntry_A1(){
		//ReplyNode Logic
		BufferedWriter writer;
		try {
			writer = this.response.getWriter();
			writer.write("MSviewprofileEntry_A1[MSviewprofileEntry]");
		} catch (IOException e) {
	...
	public void service(HttpRequest request, HttpResponse response) throws IOException {
		...
		MSviewprofileEntry_A1();
		//execetute the decision node of already executed evt
		if(this.act_exec.get("MSviewprofileEntry_A1")!=null && this.act_exec.get("MSviewprofileEntry_A1")) {
