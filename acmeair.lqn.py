...
if __name__ == '__main__':
	...
	clientEntryclientEntry_A7=Activity(stime=0.2, parent=clientEntry, name="clientEntry_A7")
	...
	clientEntryD0=probChoice(parent=clientEntry, name="clientEntryD0", 
									probs=["P_clientEntryclientEntry_A2"], 
	...
	clientEntryD1=probChoice(parent=clientEntry, name="clientEntryD1", 
									probs=["P_clientEntryclientEntry_A3"], 
	...
	clientEntryD2=probChoice(parent=clientEntry, name="clientEntryD2", 
									probs=["P_clientEntryclientEntry_A4"], 
	...
	clientEntryD3=probChoice(parent=clientEntry, name="clientEntryD3", 
									probs=["P_clientEntryclientEntry_A5"], 
	...
	clientEntryD4=probChoice(parent=clientEntry, name="clientEntryD4", 
									probs=["P_clientEntryclientEntry_A6"], 
	...
	clientEntryD5=probChoice(parent=clientEntry, name="clientEntryD5", 
									probs=["P_clientEntryclientEntry_A7"], 
	...
	MSauthEntryMSauthEntry_A2=Activity(stime=0.05, parent=MSauthEntry, name="MSauthEntry_A2")
	...
	MSauthEntryD0=probChoice(parent=MSauthEntry, name="MSauthEntryD0", 
									probs=["P_MSauthEntryMSauthEntry_A2"], 
	...
	MSvalidateidEntryMSvalidateidEntry_A1=Activity(stime=0.15, parent=MSvalidateidEntry, name="MSvalidateidEntry_A1")
	...
	MSviewprofileEntryMSviewprofileEntry_A1=Activity(stime=0.15, parent=MSviewprofileEntry, name="MSviewprofileEntry_A1")
	...
	MSupdateprofileEntryMSupdateprofileEntry_A1=Activity(stime=0.2, parent=MSupdateprofileEntry, name="MSupdateprofileEntry_A1")
	...
	MSupdateMilesEntryMSupdateMilesEntry_A1=Activity(stime=0.15, parent=MSupdateMilesEntry, name="MSupdateMilesEntry_A1")
	...
	MSbookflightsEntryMSbookflightsEntry_A5=Activity(stime=0.1, parent=MSbookflightsEntry, name="MSbookflightsEntry_A5")
	...
	MSbookflightsEntryD0=probChoice(parent=MSbookflightsEntry, name="MSbookflightsEntryD0", 
									probs=["P_MSbookflightsEntryMSbookflightsEntry_A2"], 
	...
	MSbookflightsEntryD1=probChoice(parent=MSbookflightsEntry, name="MSbookflightsEntryD1", 
									probs=["P_MSbookflightsEntryMSbookflightsEntry_A3"], 
	...
	MSbookflightsEntryD2=probChoice(parent=MSbookflightsEntry, name="MSbookflightsEntryD2", 
									probs=["P_MSbookflightsEntryMSbookflightsEntry_A4"], 
	...
	MSbookflightsEntryD3=probChoice(parent=MSbookflightsEntry, name="MSbookflightsEntryD3", 
									probs=["P_MSbookflightsEntryMSbookflightsEntry_A5"], 
	...
	MScancelbookingEntryMScancelbookingEntry_A3=Activity(stime=0.05, parent=MScancelbookingEntry, name="MScancelbookingEntry_A3")
	...
	MScancelbookingEntryD0=probChoice(parent=MScancelbookingEntry, name="MScancelbookingEntryD0", 
									probs=["P_MScancelbookingEntryMScancelbookingEntry_A2"], 
	...
	MScancelbookingEntryD1=probChoice(parent=MScancelbookingEntry, name="MScancelbookingEntryD1", 
									probs=["P_MScancelbookingEntryMScancelbookingEntry_A3"], 
	...
	MSqueryflightsEntryMSqueryflightsEntry_A1=Activity(stime=0.09, parent=MSqueryflightsEntry, name="MSqueryflightsEntry_A1")
	...
	MSgetrewardmilesEntryMSgetrewardmilesEntry_A1=Activity(stime=0.1, parent=MSgetrewardmilesEntry, name="MSgetrewardmilesEntry_A1")
