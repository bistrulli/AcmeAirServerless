...
public class Logic implements HttpFunction {
	private static final Logger logger = Logger.getLogger("MSupdateMilesEntry");
	 ...
	 * activities
	 */
	public void MSupdateMilesEntry_A1(){
		this.act_exec.put("MSupdateMilesEntry_A1", true);
		this.doWork(0.02508);
	}
	 ...
	 * Dnodes
	 */
	public void ReplyNode_MSupdateMilesEntry_A1(){
		//ReplyNode Logic
		BufferedWriter writer;
		try {
			writer = this.response.getWriter();
			writer.write("MSupdateMilesEntry_A1[MSupdateMilesEntry]");
		} catch (IOException e) {
	...
	public void service(HttpRequest request, HttpResponse response) throws IOException {
		...
		if(this.act_exec.get("MSupdateMilesEntry_A1")!=null && this.act_exec.get("MSupdateMilesEntry_A1")) {
		  this.act_exec.put("MSupdateMilesEntry_A1",false);
		  ReplyNode_MSupdateMilesEntry_A1();
		}
